function   [wm1,phim1,wm3,phim3,Mi] = influence_matrix(D,D2,riprime,K,delta,It)
...
for m=0:1:K % Loop for each Fourier mode
    ...
    %
    % Note: delta = (2/3)*Pr*dt for the second-order time-stepping scheme, 
    %       delta = Pr*dt for the first-order time-stepping scheme
    %
    % first solve for w
