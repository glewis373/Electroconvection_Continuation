function [T_inv,c_int,D,D2,yi,I,It,theta,riprime] = make_grids(Nc,K,rr)

[T_inv,c_int,D, D2,yi] = ccheb(Nc); % calculating the differentiation matrices for Chebyshev collocation unkowns; yi = Chebyshev grids
