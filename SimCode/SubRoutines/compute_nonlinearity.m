function [Jqphi_m,Jwphi_m,Jpsi2q_m] = compute_nonlinearity(psi2m,Wm,Phim,qm,Q0_r,Psi20_r,riprime,Nonlinear,D,Nc,q)
...
% compute J_{q phi} = dQ/dr dphi/dtheta + dq/dr dphi/dtheta - dphi/dr dq/dtheta
Jqphi = diag(Q0_r)*dphi + Nonlinear*(drq.*dphi- drphi.*dq);
...
% compute J_{w phi} =  dw/dr dphi/dtheta - dphi/dr dw/dtheta
Jwphi =   Nonlinear*(drw.*dphi-drphi.*dw);
...
Jpsi2q = diag(Psi20_r(:,1))*dq - diag(Q0_r)*dpsi2 + Nonlinear*(drpsi2.*dq-drq.*dpsi2);
